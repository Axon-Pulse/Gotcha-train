        ...
        return html.Div([
                ...
                dbc.Container([
                    dash_table.DataTable(
                                            ...
                                            style_table={'height': '400px', 'overflowY': 'auto', 'display': 'block'},
                                            style_header={'backgroundColor': 'rgb(230, 230, 230)','fontWeight': 'bold'},
                                            style_cell={'textAlign': 'left'},                       
                                            id='table-data'),
                    dbc.Button("View Data Table", id="view-table-btn", className="mb-3",style={'backgroundColor': '#007BFF'}),
                    dbc.Button("Hide Data Table", id="hide-table-btn", className="mb-3",style={'backgroundColor': '#FF4136', 'margin-left': '10px'}),
 ...
 # Create the layoutr based on the selected option
    def create_layout(self, selected_option):
        if 'data_analysis' in selected_option:
            ...
            layout = DataAnalysisLayout().data_analysis_layout(self.transforms, self.default_transforms)

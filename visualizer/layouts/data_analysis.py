                ...
                2. Select the sample from the table.
                        ...
                        dcc.RadioItems(
                            ...
                            labelStyle={
                                ...
                                "marginRight": "20px",
                            },  # Display options in a horizontal line
                        ),
                        html.Hr(),
                            ...
                            [
                                dbc.Row(
                                    [
                                        dbc.Col(
                                            [
                                                html.H4("Transform Names"),
                                                dbc.Checklist(
                                                    id="transforms-checklist",
                                                    options=[
                                                        {"label": key, "value": key}
                                                    ...
                                                    value=[
                                                        selected
                                                        for selected in self.predict_trans["order"]
                                                    ],
                                                ),
                                            ]
                                        ),
                                ...
                                html.Button(
                                    "Apply Transforms", id="apply-transform-button", n_clicks=0
                                ),

...
# A a link for the drive to download an example dataset is provided, just drop it on data/ISAR
# link: https://drive.google.com/file/d/1BFU2zBqKrW2K_sZanwSIyx0IGXffRAgm/view?usp=drive_link


class ISARDataModule(LightningDataModule):
    """`LightningDataModule` for the ISAR dataset.
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        if self.cfg_datasets.get("train_val_test_split"):
            ...
            self.main_dataset = self._get_dataset_(data_list_names[1])
